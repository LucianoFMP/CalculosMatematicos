...
<head>
    ...
    <title>Exercício 3 - Cálculo do Fatorial</title>
</head>
<body>
...
.button2:active {
  ...
  transform: translateY(4px);
    ...
    if (isset($_POST['numerodigitado'])) {
        $num = $_POST['numerodigitado'];
              
        function calcularFat($x) {
            if ($x <= 1) {
                return 1;
            } else {
                return $x * calcularFat ($x - 1);
                }
        }
        
        $resultado = calcularFat($num);
        echo "O fatorial de <br><br> * $num * <br><br> é <br><br> * $resultado *";
    }
    ?>
    </div>
    
    <a href="exercicio3.html" class="button2"><b>Escolher outro número</b></a>
