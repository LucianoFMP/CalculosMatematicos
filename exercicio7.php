...
<head>
    ...
    <title>Exercício 7 - Maior Número</title>
</head>
<body>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['numero1']) && isset($_POST['numero2'])) {
        ...
        if ($num1 > $num2) {
            echo "*$num1* <br><br> é maior do que <br><br> *$num2*";

        } elseif ($num1 < $num2) {
            echo "*$num2* <br><br> é maior do que <br><br> *$num1*";
        }
            else {
...
?>
    ...
    <a href="exercicio7.html" class="button2"><b>Escolher novos valores</b></a>
